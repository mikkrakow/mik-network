...
<div style="margin:1em 0;">	
     <span class="spacer">Gdzie jestem?&nbsp;</span><span>
PRZEGLĄDASZ:</span><br />
 <span class="spacer2"><a href="<?php bloginfo('url'); ?>">&nbsp;<?php bloginfo('name'); ?></a></span><span class="spacer2">&nbsp;<?php the_title(); ?></span>	    </div>
...
?></li>
    ...
    <?php } elseif (is_category()) { ?>
     ...
     <span class="spacer">Gdzie jestem?&nbsp;</span><span>
PRZEGLĄDASZ:</span><br />
 <span class="spacer2"><a href="<?php bloginfo('url'); ?>">&nbsp;<?php bloginfo('name'); ?></a></span><span class="spacer2">&nbsp;<?php single_cat_title(''); ?></span>	    </div>
...
<p><?php echo category_description( $category_id ); ?></p>
    ...
    <?php } elseif (is_tag()) { ?>
     ...
     <span class="spacer">Gdzie jestem?&nbsp;</span><span>
PRZEGLĄDASZ:</span><br />
 <span class="spacer2"><a href="<?php bloginfo('url'); ?>">&nbsp;<?php bloginfo('name'); ?></a></span><span class="spacer2">&nbsp;<?php single_tag_title(); ?></span>	    </div>
    ...
    <?php } elseif (is_month()) { ?>
     ...
     <span class="spacer">Gdzie jestem?&nbsp;</span><span>
PRZEGLĄDASZ:</span><br />
 <span class="spacer2">&nbsp;<?php the_time('F, Y'); ?></span>
 </div>
