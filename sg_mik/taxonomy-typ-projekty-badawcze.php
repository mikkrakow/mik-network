...
<span class="spacer2"><a href="<?php bloginfo('url'); ?>">&nbsp;<?php bloginfo('name'); ?></a></span><span class="spacer2">&nbsp;<a href="<?php bloginfo('url'); ?>/typ/dzialania/">działania</a></span><span class="spacer2">&nbsp;<?php single_cat_title(''); ?></span>	    </div>			  
			  <p>Sortuj według:</p>
		

<ul>
<li><?php wp_list_categories('taxonomy=typ&orderby=name&include=382,91,778,389&title li=obszary działań'); ?></li>
	
	<li><?php wp_list_categories('taxonomy=typ&orderby=name&include=170,388,82,428,586,2143,48,2145,386,2148&title li=metody działań'); ?></li>
		</ul>
