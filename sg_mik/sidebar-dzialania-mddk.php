...
<a href="<?php bloginfo('url'); ?>/tag/malopolskie-dni-dziedzictwa-kulturowego/"><img src="<?php bloginfo('template_directory'); ?>/images/arrow-menu.gif" alt="czytaj więcej" title="więcej" /> Małopolskie Dni Dziedzictwa Kulturowego</a></p>
...
// The Query
$the_query = new WP_Query( 'tag_id=24' );
...
<p class="alignleft"><a href="<?php bloginfo('url'); ?>/tag/malopolskie-dni-dziedzictwa-kulturowego/">&laquo; Starsze wpisy</a></p>
</div>
