...
<a href="<?php bloginfo('url'); ?>/tag/biblioteka-sztuki-spotkania/page/2/"><img src="<?php bloginfo('template_directory'); ?>/images/arrow-menu.gif" alt="czytaj więcej" title="więcej" /> Biblioteka Sztuki. Spotkania</a></p>
    
    
     <li>
	<a href="http://www.flickr.com/photos/mik_krakow/tags/bibliotekasztuki/"><h2 class="widgettitle">Biblioteka Sztuki na zdjęciach</h2></a>
		<ul>
		<?php echo do_shortcode('[flickrpress type="photostream" api_key="2b41099518917cb8ebb7eb0d056ac5b1" account="33122810@N02" tags="bibliotekasztuki" view="squares" count="15" random="true" lightbox="true"]'); ?>
		</ul>
		</li>
	</ul>
</div>
...
// The Query
$the_query = new WP_Query( 'tag_id=16' );
...
<p class="alignleft"><a href="<?php bloginfo('url'); ?>/tag/biblioteka-sztuki-spotkania/page/2/">&laquo; Starsze wpisy</a></p>
</div>
</div>
