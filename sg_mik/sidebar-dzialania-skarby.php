...
<a href="<?php bloginfo('url'); ?>/tag/konkurs-skarby-malopolski/"><img src="<?php bloginfo('template_directory'); ?>/images/arrow-menu.gif" alt="czytaj więcej" title="więcej" /> Konkurs "Skarby Małopolski"</a></p>
...
// The Query
$the_query = new WP_Query( 'tag_id=115' );
...
<p class="alignleft"><a href="<?php bloginfo('url'); ?>/tag/konkurs-skarby-malopolski/">&laquo; Starsze wpisy</a></p>
</div>
