...
<p><h2 class="widgettitle">Partnerzy Chłopskiej Szkoły Biznesu:</h2>
<a href="http://www.tma.andrychow.eu/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/andrychow.jpg" alt="Towarzystwo Miłosników Andrychowa"></a></p>
	
<p>więcej wpisów oznaczonych tagiem<br />
<a href="<?php bloginfo('url'); ?>/tag/chlopska-szkola-biznesu/page/2/"><img src="<?php bloginfo('template_directory'); ?>/images/arrow-menu.gif" alt="czytaj więcej" title="więcej" /> Chłopska Szkoła Biznesu</a></p>
    
    
	  <ul>
		<li>
	<a href="http://www.flickr.com/photos/mik_krakow/tags/ch%C5%82opskaszko%C5%82abiznesu/"><h2 class="widgettitle">Chłopska Szkoła Biznesu na zdjęciach</h2></a>
		<ul>
		<?php echo do_shortcode('[flickrpress type="photostream" api_key="2b41099518917cb8ebb7eb0d056ac5b1" account="33122810@N02" tags="chłopska szkoła biznesu" view="squares" count="12" random="true" lightbox="true"]'); ?>
		</ul>
		</li>
		</ul>    
...
<p class="alignleft"><a href="<?php bloginfo('url'); ?>/tag/chlopska-szkola-biznesu/page/2/">&laquo; Starsze wpisy</a></p>
</div>
