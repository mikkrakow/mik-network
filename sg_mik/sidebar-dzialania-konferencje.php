...
<a href="<?php bloginfo('url'); ?>/tag/konferencja/page/2/"><img src="<?php bloginfo('template_directory'); ?>/images/arrow-menu.gif" alt="czytaj więcej" title="więcej" /> Konferencja</a></p>
    
	<ul>
	<li><?php echo do_shortcode('[flickrpress type="photostream" api_key="2b41099518917cb8ebb7eb0d056ac5b1" account="33122810@N02" tags="konferencja" view="squares" count="18" random="true" lightbox="true"]'); ?></li>
	</ul>
...
// The Query
$the_query = new WP_Query( 'tag_id=90' );
...
<p class="alignleft"><a href="<?php bloginfo('url'); ?>/tag/konferencja/page/2/">&laquo; Starsze wpisy</a></p>
</div>
