...
<a href="<?php bloginfo('url'); ?>/tag/zbiornik-kultury/page/2/"><img src="<?php bloginfo('template_directory'); ?>/images/arrow-menu.gif" alt="czytaj więcej" title="więcej" /> Zbiornik Kultury</a></p>
...
// The Query
$the_query = new WP_Query( 'tag_id=12' );
...
<p class="alignleft"><a href="<?php bloginfo('url'); ?>/tag/zbiornik-kultury/page/2/">&laquo; Starsze wpisy</a></p>
</div>
