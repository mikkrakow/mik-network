...
<span class="spacer2"><a href="<?php bloginfo('url'); ?>">&nbsp;<?php bloginfo('name'); ?></a></span><span class="spacer2">&nbsp;<a href="<?php bloginfo('url'); ?>dzialania-archiwalne/">działania archiwalne</a></span><span class="spacer2">&nbsp;<?php single_cat_title(''); ?></span>	    </div>
			  
			  <p>Sortuj według:</p>	

<ul>
<li><?php wp_list_categories('taxonomy=typ&orderby=name&include=788,870,403,789,408&title_li=obszary działań' ); ?></li>
</ul>
	

		<ul> 
	<li><?php wp_list_categories('taxonomy=typ&orderby=name&include=400,871,406,407,409,410&title_li=metody działań'); ?></li>
		<li></li>
		</ul>
