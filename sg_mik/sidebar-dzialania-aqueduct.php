...
<a href="<?php bloginfo('url'); ?>/tag/aqueduct/"><img src="<?php bloginfo('template_directory'); ?>/images/arrow-menu.gif" alt="czytaj więcej" title="więcej" /> Aqueduct</a></p>
...
// The Query
$the_query = new WP_Query( 'tag_id=28' );
...
<p class="alignleft"><a href="<?php bloginfo('url'); ?>/tag/aqueduct/">&laquo; Starsze wpisy</a></p>
</div>
