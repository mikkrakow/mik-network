<?php
/*
Template Name: dynamika-ekspozycji
*/
?>
...
<div id="content">
  ...
  <?php endif; ?>
	...
	<span class="spacer2"><a href="<?php bloginfo('url'); ?>">&nbsp;<?php bloginfo('name'); ?></a></span><span class="spacer2">&nbsp;Dynamika Ekspozycji</span>
	</div><!--close gdzie jestem -->

		<ul>
        <li>
      <a href="/warsztaty"><h2 class="widgettitle">Warsztaty</h2></a>
      <ul>
        <?php query_posts('cat=429&showposts=3'); ?>
		<?php while (have_posts()): the_post(); ?>
		<li><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></li>
		<?php endwhile; ?>
		<li>&nbsp;&nbsp;&nbsp;<a href="/category/warsztaty">więcej...</a>
      </ul>
    </li>
    </ul>
	...
	<ul>
        <li>
      <a href="/wystawy"><h2 class="widgettitle">Wystawy</h2></a>
      <ul>
        <?php query_posts('cat=27&showposts=3'); ?>
		<?php while (have_posts()): the_post(); ?>
		<li><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></li>
		<?php endwhile; ?>
		<li>&nbsp;&nbsp;&nbsp;<a href="/category/wspolpraca/wystawy-wspolpraca">więcej...</a>
      </ul>
    </li>
    </ul>
		...
		<ul>
        <li>
      <a href="/sciezki-edukacyjne"><h2 class="widgettitle">Ścieżki edukacyjne</h2></a>
      <ul>
        <?php query_posts('cat=31&showposts=3'); ?>
		<?php while (have_posts()): the_post(); ?>
		<li><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></li>
		<?php endwhile; ?>
		<li>&nbsp;&nbsp;&nbsp;<a href="/category/wspolpraca/sciezki-edukacyjne/">więcej...</a>
      </ul>
    </li>
    </ul>
	...
	<ul>
        <li>
      <a href="/konsultacje"><h2 class="widgettitle">Konsultacje</h2></a>
      <ul>
        <?php query_posts('cat=29&showposts=3'); ?>
		<?php while (have_posts()): the_post(); ?>
		<li><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></li>
		<?php endwhile; ?>
		<li>&nbsp;&nbsp;&nbsp;<a href="/category/wspolpraca/konsultacje/">więcej...</a>
      </ul>
    </li>
    </ul>
