...
<div id="content">
  ...
  <?php endif; ?>
	...
	<span class="spacer2"><a href="<?php bloginfo('url'); ?>">&nbsp;<?php bloginfo('name'); ?></a></span><span class="spacer2">&nbsp;warsztaty</span>
	</div><!--close gdzie jestem -->
	
		
		<ul>
        <li>
      <h2 class="widgettitle">Archiwum warsztatów</h2>
      <ul>
        <?php query_posts('cat=429&showposts=200'); ?>
		<?php while (have_posts()): the_post(); ?>
